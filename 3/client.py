...
from common.variables import ACTION, PRESENCE, TIME, USER, ACCOUNT_NAME, \
    RESPONSE, ERROR, DEFAULT_IP_ADDRESS, DEFAULT_PORT, MESSAGE_TEXT, MSG, SENDER, EXIT, DESTINATION, GET_CONTACTS, \
    LIST_INFO, ADD_CONTACT, USERS_REQUEST, REMOVE_CONTACT
...
class Client(threading.Thread, metaclass=ClientMaker):
    ...
    @log
    def message_from_server(self, sock, account_name):
...
def arg_parser():
    ...
    # server_port = DeskPortCheck(namespace.port)
