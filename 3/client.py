...
from common.variables import ACTION, PRESENCE, TIME, USER, ACCOUNT_NAME, \
    RESPONSE, ERROR, DEFAULT_IP_ADDRESS, DEFAULT_PORT, MESSAGE_TEXT, MSG, SENDER, EXIT, DESTINATION
...
def main():
    ...
    try:
        ...
        transport.connect((server_address, DEFAULT_PORT))
